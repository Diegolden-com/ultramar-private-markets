...
| Liquidity Operators | Hooks can control who supplies/removes liquidity and under what conditions. | Public LP behavior is blocked. Issuer/escrow inventory is consumed through capital windows instead of passive public LP deposits. |
