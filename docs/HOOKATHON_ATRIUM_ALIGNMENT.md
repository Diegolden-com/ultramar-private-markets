...
| Uniswap Math | Know which price mechanism the hook is changing. | The demo intentionally replaces public AMM price discovery with a deterministic sandbox capital-window conversion curve. The approved demo settles `1500.00` demo USDC into `1454.54` sandbox restricted LCX at `1.0312` demo USDC/restricted LCX. |
