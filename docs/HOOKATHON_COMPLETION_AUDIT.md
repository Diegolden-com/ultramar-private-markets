...
| Demo video upload | External pending | Captioned WebM review cut exists locally at `artifacts/hookathon/video/final-demo-latest.webm`; upload URL is still pending. |
