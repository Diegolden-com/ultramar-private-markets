...
const requiredArtifacts = [
  ...
  ["Market readiness frame", "artifacts/hookathon/frames/02-market-readiness.png"],
  ["Operating readiness frame", "artifacts/hookathon/frames/03-operating-readiness-map.png"],
  ["Approved equity route frame", "artifacts/hookathon/frames/04-equity-route-approved.png"],
  ["Debt covenant stale frame", "artifacts/hookathon/frames/05-debt-covenant-stale.png"],
  ["Generic router frame", "artifacts/hookathon/frames/06-generic-router-revert.png"],
  ["Pricing policy frame", "artifacts/hookathon/frames/07-pricing-policy.png"],
  ["Specialized Markets frame", "artifacts/hookathon/frames/08-specialized-markets-claim.png"],
  ["Deck capital routes frame", "artifacts/hookathon/frames/09-deck-capital-routes.png"],
  ["Pricing proof frame", "artifacts/hookathon/frames/10-pricing-proof.png"],
  ["Pitch deck close frame", "artifacts/hookathon/frames/11-pitch-deck-close.png"],
...
const requiredNarrativeMarkers = [
  ...
  ["Submission form operating readiness", "docs/HOOKATHON_SUBMISSION_FORM.md", "Operating readiness thesis"],
  ...
  ["Submission packet operating readiness", "docs/HOOKATHON_SUBMISSION_PACKET.md", "Operating readiness"],
  ...
  ["Final packet fixed FX copy", "docs/HOOKATHON_TALLY_FINAL_PACKET.md", "active window is fixed after the signed FX snapshot"],
  ["Final packet floating FX copy", "docs/HOOKATHON_TALLY_FINAL_PACKET.md", "floating policy can refresh the next window"],
  ...
  ["Final handoff command", "docs/HOOKATHON_TALLY_FINAL_PACKET.md", "corepack yarn hookathon:submission:handoff"],
