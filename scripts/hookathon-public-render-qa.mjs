...
const pages = [
  {
    ...
    markers: [
      ...
      "Settlement math",
      "Signed settlement schedule executed inside the approved equity window.",
      ...
      "Before-swap receipt",
      "Admin proof becomes an equity route when verified claim, route, and v4 hook agree.",
      "Admin proof -> verified claim -> route -> v4 hook",
      "Daily close, route density, ticket mix, and utilization.",
      "Fresh revenue plus signed margin expansion target.",
      "Passport, cap, oracle freshness, and exact-input settlement.",
      "Evidence chain",
      ...
      "Route",
      "v4 hook",
      "Daily close + route density fresh",
      "Revenue + margin proof fresh",
      "Primary restricted LCX sandbox equity",
      "Passport active; custom delta returned",
      "1,454.54 sandbox restricted LCX",
