        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center justify-center gap-0.5 font-mono text-xs transition-colors ${
                item.isActive ? "bg-foreground text-background" : "hover:bg-muted"
              }`}
            >
