...
import { ShieldCheck, Database, Globe, RefreshCw, Server, Binary } from "lucide-react"
...
function Card({ icon, title, desc, step }: { icon: React.ReactNode, title: string, desc: string, step: string }) {
    return (
