...
import { Activity, Lock, Network, ArrowUpRight } from "lucide-react"
import Link from "next/link"
import Image from "next/image"

export function TechSpecs() {
    return (
        <section className="bg-background text-foreground py-12 sm:py-24 relative overflow-hidden selection:bg-accent selection:text-background">
            ...
            <p className="font-serif text-xl italic text-muted-foreground mt-12 text-center">
