  ...
  return (
    <>
      ...
      <div className="grid animate-pulse gap-4" aria-label="Loading data room" role="status">
        <div className="lcx-dossier-state h-44 border border-border-muted bg-surface" />
        <div className="lcx-dossier-workspace grid min-h-[520px] border border-border-muted bg-surface lg:grid-cols-[15rem_minmax(0,1fr)_20rem]">
