    ...
    <section className="border-t border-border bg-card/40">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-10 sm:px-6 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <h2 className="mt-2 font-serif text-3xl font-bold">{target.name}</h2>
        ...
        <Link
          href={target.href}
          className="inline-flex w-fit items-center gap-2 rounded border border-border bg-background px-4 py-2 font-mono text-xs font-bold uppercase tracking-widest hover:border-accent hover:text-accent"
        >
          View Product
