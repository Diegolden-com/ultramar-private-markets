...
import { Activity, Scale, Zap, Lock, Eye, Network } from "lucide-react"
        ...
        <section className="bg-foreground text-background py-24 sm:py-32 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid md:grid-cols-3 gap-px bg-background/20 max-w-6xl mx-auto border border-background/20">
                    {/* Card 1: The Oracle */}
                    <div className="bg-foreground p-8 sm:p-12 group hover:bg-zinc-900 transition-colors duration-500 relative overflow-hidden">
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between">
                            <div>
                                <div className="flex items-center gap-3 mb-6">
                                    <div className="p-2 border border-background/20 rounded-full">
                                        <Activity className="w-5 h-5 text-accent" />
                                    </div>
                                    <h3 className="font-bold font-mono text-xl tracking-tight">THE ORACLE</h3>
                                </div>
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between">
                            <div>
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h3 className="font-bold font-mono text-xl tracking-tight">THE MARKET</h3>
                                </div>
                                <p className="text-background/60 font-sans leading-relaxed mb-8">
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between">
                            <div>
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h3 className="font-bold font-mono text-xl tracking-tight">THE LAW</h3>
                                </div>
                                <p className="text-background/60 font-sans leading-relaxed mb-8">
