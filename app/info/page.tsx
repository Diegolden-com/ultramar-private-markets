...
export default function InfoPage() {
    return (
        <main className="container mx-auto px-4 py-8 sm:py-12 max-w-5xl pb-24">
            {/* Hero Section */}
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-mono mb-6 text-sky-900 dark:text-sky-100">
                PRIVATE EQUITIES
            </h1>
            <p className="text-lg sm:text-xl font-mono text-slate-600 dark:text-slate-300 mb-12 max-w-3xl leading-relaxed">
                Giving investors exposure to real, brick-and-mortar businesses across latitudes and longitudes,
